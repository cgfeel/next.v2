...
import VercelLogo from "./icon/VercelLogo";

const Byline: FC<BylineProps> = ({ className }) => (
    <div
        className={`${className} inset-x-0 bottom-3 mx-3 rounded-lg bg-vc-border-gradient p-px shadow-lg shadow-black/20`}
    >
        <div 
            className="flex flex-row justify-between rounded-lg bg-black p-3.5 lg:px-5 lg:py-3"
        >
            <div 
