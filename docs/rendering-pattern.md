...
- 然后动态的内容通过`Suspense`包裹，NextJS将会通过占位的方式优先进行渲染
- 随后通过推流替换占位内容
...
<summary>以下是内部交流截图</summary>
  
![2331701967035_ pic](https://github.com/cgfeel/next.v2/assets/578141/6e635cf1-bc89-4dab-adee-e61e0565a70f)
