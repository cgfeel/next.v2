import { dancingScript, inter, merriweather, oswald, raleway, roboto, robotoArray } from "@/src/utils/fonts";
...
export default function Page() {
    return (
        ...
        >
            ...
            <div 
                className={robotoArray.className}
            >
                This is a roboto array font.
            </div>
            <hr />
            <div 
