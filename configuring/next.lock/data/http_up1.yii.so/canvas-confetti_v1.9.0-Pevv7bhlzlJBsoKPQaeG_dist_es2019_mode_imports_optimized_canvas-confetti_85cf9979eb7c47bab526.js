...
(function main(global, module2, isWorker, workerSize) {
  ...
  function shapeFromText(textData) {
    var text, scalar = 1, color = "#000000", fontFamily = '"Twemoji Mozilla", "Apple Color Emoji", "Segoe UI Emoji", "Segoe UI Symbol", "Noto Color Emoji", "EmojiOne Color", "Android Emoji", "system emoji", sans-serif';
